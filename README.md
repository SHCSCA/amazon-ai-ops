...
| 当前安装包证据 | 已进入 final-readiness | installer `apps\desktop\release\AmazonAIOpsAgent-1.5.0.exe`，大小 `83130578`，SHA-256 `53DDD6A9C175C173EB005B599F6DC35BB1E04C80C5696F6177B18766A7C35FFD`；portable `apps\desktop\release\AmazonAIOpsAgent-1.5.0-portable.exe`，大小 `82964827`，SHA-256 `8B32CFDC6AA69B8278283AAB3F03015FF5DF55524B75109B65A732E75E77CE3E` |
| 当前安装/免安装启动复验 | 通过 | `pnpm run smoke:package-launch` 通过，证据 `output\codex-evidence\package-launch-smoke-1782870887976.json`；`win-unpacked` 到达 `ipc-ready/window-created`，portable 从 Temp 解压并启动子进程 |
...
| 2 | 复核当前 READY 证据 | `output\codex-evidence\final-readiness-20260701095536.json`、`output\codex-evidence\package-launch-smoke-1782870887976.json`、`output\delivery-bundles\v15-delivery-bundle-20260701095536-ready\delivery-bundle-manifest.json` 三者必须同属当前 package hash |
...
pnpm run write:v15-evidence-manifest --ad-readback output\codex-evidence\real-ad-execution-readback-candidate-rec-4-current-pass.json --out output\codex-evidence\v15-final-readiness-evidence-manifest-20260701095536.json
pnpm run verify:v15-delivery
pnpm run verify:v15-final-readiness --evidence-manifest output\codex-evidence\v15-final-readiness-evidence-manifest-20260701095536.json --package-launch-smoke output\codex-evidence\package-launch-smoke-1782870887976.json --out output\codex-evidence\final-readiness-20260701095536.json
# 先把 README 顶部 DELIVERY 行切到当前证据对应的 `APP_READY`，再导出交付包；导出器会拒绝 IN_PROGRESS README。
pnpm run export:v15-delivery-bundle --final-readiness output\codex-evidence\final-readiness-20260701095536.json --data-reconciliation output\codex-evidence\real-lingxing-reconciliation-batch_20260612020905629_gkchz1.json --data-reconciliation-md output\codex-evidence\real-lingxing-reconciliation-batch_20260612020905629_gkchz1.md --out output\delivery-bundles\v15-delivery-bundle-20260701095536-ready
pnpm run verify:v15-ready-safety --final-readiness output\codex-evidence\final-readiness-20260701095536.json --bundle-manifest output\delivery-bundles\v15-delivery-bundle-20260701095536-ready\delivery-bundle-manifest.json
```
