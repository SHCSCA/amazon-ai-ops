...
| Gate | Evidence |
| --- | --- |
| Final readiness | `output\codex-evidence\final-readiness-20260625173156.json` |
| Evidence selection | `output\codex-evidence\v15-final-readiness-evidence-manifest-20260625173156.json` |
| Delivery bundle | `output\delivery-bundles\v15-delivery-bundle-20260625173156-ready` |
| Current package launch smoke | `output\codex-evidence\package-launch-smoke-1782379867590.json` |
...
| Installer size | `83111444` bytes |
| Installer last write | `2026-06-25 17:12:53` |
| Portable/no-install SHA-256 | `C1E35AD3989422B10B9BF0BA61292C1815D79160C105E30FD3ECFE032190F858` |
| Portable/no-install size | `82945694` bytes |
| Portable/no-install last write | `2026-06-25 17:12:54` |
