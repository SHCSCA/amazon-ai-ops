...
| Gate | Evidence |
| --- | --- |
| Final readiness | `output\codex-evidence\final-readiness-20260630102430.json` |
| Evidence selection | `output\codex-evidence\v15-final-readiness-evidence-manifest-20260630102430.json` |
| Delivery bundle | `output\delivery-bundles\v15-delivery-bundle-20260630102430-ready` |
| Current package launch smoke | `output\codex-evidence\package-launch-smoke-1782786245543.json` |
...
| Field | Value |
| --- | --- |
| Installer SHA-256 | `5543486E059C38C84917C19C8A53A551EF06F9BFED32E739EB024935FAF83C74` |
| Installer size | `83124259` bytes |
| Installer last write | `2026-06-30 10:23:44` |
| Portable/no-install SHA-256 | `7565D7333E7BE45313353CC68EC8D922BEEA938AE198F4FB48CB14B64079EBA1` |
| Portable/no-install size | `82958510` bytes |
| Portable/no-install last write | `2026-06-30 10:23:45` |
