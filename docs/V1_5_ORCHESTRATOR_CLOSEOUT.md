...
| Gate | Evidence |
| --- | --- |
| Final readiness | `output\codex-evidence\final-readiness-20260626084710.json` |
| Evidence selection | `output\codex-evidence\v15-final-readiness-evidence-manifest-20260626084710.json` |
| Delivery bundle | `output\delivery-bundles\v15-delivery-bundle-20260626084710-ready` |
| Current package launch smoke | `output\codex-evidence\package-launch-smoke-1782434806166.json` |
...
| Installer size | `83112734` bytes |
| Installer last write | `2026-06-26 08:46:11` |
| Portable/no-install SHA-256 | `F5EEBB7E1EC5B2714439709D480F3DF10671D14DABDC19CD055F6795E4F723F3` |
| Portable/no-install size | `82946988` bytes |
| Portable/no-install last write | `2026-06-26 08:46:12` |
