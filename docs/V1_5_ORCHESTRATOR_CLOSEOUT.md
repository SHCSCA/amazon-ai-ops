...
| Gate | Evidence |
| --- | --- |
| Final readiness | `output\codex-evidence\final-readiness-20260630092431.json` |
| Evidence selection | `output\codex-evidence\v15-final-readiness-evidence-manifest-20260630092431.json` |
| Delivery bundle | `output\delivery-bundles\v15-delivery-bundle-20260630092431-ready` |
| Current package launch smoke | `output\codex-evidence\package-launch-smoke-1782782637940.json` |
...
| Field | Value |
| --- | --- |
| Installer SHA-256 | `1303E2A36E1741298FD53FB34717814D8DBF093A1251B14C945F30895A61901F` |
| Installer size | `83123162` bytes |
| Installer last write | `2026-06-30 09:23:37` |
| Portable/no-install SHA-256 | `66ED193CD505304B53628886C92EA39ED08083544855C4BC2BB62A6B4F88A52B` |
| Portable/no-install size | `82957410` bytes |
| Portable/no-install last write | `2026-06-30 09:23:39` |
