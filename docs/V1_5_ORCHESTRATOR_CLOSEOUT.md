...
| Gate | Evidence |
| --- | --- |
| Final readiness | `output\codex-evidence\final-readiness-20260626162310.json` |
| Evidence selection | `output\codex-evidence\v15-final-readiness-evidence-manifest-20260626162310.json` |
| Delivery bundle | `output\delivery-bundles\v15-delivery-bundle-20260626162310-ready` |
| Current package launch smoke | `output\codex-evidence\package-launch-smoke-1782462167583.json` |
...
| Installer size | `83118569` bytes |
| Installer last write | `2026-06-26 16:22:36` |
| Portable/no-install SHA-256 | `D045A1B623D5556C2669CAEA42926CF7BF5EE028CDF1BA92C91A456A1BC9E688` |
| Portable/no-install size | `82952818` bytes |
| Portable/no-install last write | `2026-06-26 16:22:38` |
