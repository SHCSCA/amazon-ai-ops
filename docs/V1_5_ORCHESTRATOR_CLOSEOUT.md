...
| Gate | Evidence |
| --- | --- |
| Final readiness | `output\codex-evidence\final-readiness-20260626095930.json` |
| Evidence selection | `output\codex-evidence\v15-final-readiness-evidence-manifest-20260626095930.json` |
| Delivery bundle | `output\delivery-bundles\v15-delivery-bundle-20260626095930-ready` |
| Current package launch smoke | `output\codex-evidence\package-launch-smoke-1782439149193.json` |
...
| Field | Value |
| --- | --- |
| Installer SHA-256 | `1C6401815D4DB8A89FC8A60458F5B8C67D7349743AF5FD39F07951D8C44F6A6F` |
| Installer size | `83114806` bytes |
| Installer last write | `2026-06-26 09:58:52` |
| Portable/no-install SHA-256 | `0E39B1CB4732C2B9FF159C8753BE217E0AB7362247E58E153F651FDBC74E4C0D` |
| Portable/no-install size | `82949056` bytes |
| Portable/no-install last write | `2026-06-26 09:58:54` |
