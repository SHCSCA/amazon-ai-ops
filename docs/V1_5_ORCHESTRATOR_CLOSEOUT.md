...
| Gate | Evidence |
| --- | --- |
| Final readiness | `output\codex-evidence\final-readiness-20260629124819.json` |
| Evidence selection | `output\codex-evidence\v15-final-readiness-evidence-manifest-20260629124819.json` |
| Delivery bundle | `output\delivery-bundles\v15-delivery-bundle-20260629124819-ready` |
| Current package launch smoke | `output\codex-evidence\package-launch-smoke-1782708500597.json` |
...
| Field | Value |
| --- | --- |
| Installer SHA-256 | `B86BF6B4AB8DCDC42041060FC1E274D0EB5BC22D679F98313E32E84655468A89` |
| Installer size | `83121556` bytes |
| Installer last write | `2026-06-29 12:48:04` |
| Portable/no-install SHA-256 | `B0BA6DD4FBF8D2086187A8765A9F3ECFF02E2DF746B3B9CD3C86FC8EAA28FABA` |
| Portable/no-install size | `82955811` bytes |
| Portable/no-install last write | `2026-06-29 12:48:06` |
