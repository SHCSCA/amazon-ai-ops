...
| Gate | Evidence |
| --- | --- |
| Final readiness | `output\codex-evidence\final-readiness-20260629142255.json` |
| Evidence selection | `output\codex-evidence\v15-final-readiness-evidence-manifest-20260629142255.json` |
| Delivery bundle | `output\delivery-bundles\v15-delivery-bundle-20260629142255-ready` |
| Current package launch smoke | `output\codex-evidence\package-launch-smoke-1782714133821.json` |
...
| Field | Value |
| --- | --- |
| Installer SHA-256 | `A3962D15BF0D31995D13DB280F94B6B609FE274A3A8D6EE5CC870F25CC2B4336` |
| Installer size | `83122478` bytes |
| Installer last write | `2026-06-29 14:21:46` |
| Portable/no-install SHA-256 | `3B06F2B2FEA0BAF0813E9C594CE9E94266EB4BA1CD8BECF0102F586717ABC6ED` |
| Portable/no-install size | `82956725` bytes |
| Portable/no-install last write | `2026-06-29 14:21:48` |
