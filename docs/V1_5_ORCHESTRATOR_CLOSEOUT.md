...
| Gate | Evidence |
| --- | --- |
| Final readiness | `output\codex-evidence\final-readiness-20260630122902.json` |
| Evidence selection | `output\codex-evidence\v15-final-readiness-evidence-manifest-20260630122902.json` |
| Delivery bundle | `output\delivery-bundles\v15-delivery-bundle-20260630122902-ready` |
| Current package launch smoke | `output\codex-evidence\package-launch-smoke-1782793720191.json` |
...
| Field | Value |
| --- | --- |
| Installer SHA-256 | `B1FDDB07CA8CDC6F5A47A80DBF7416A48D5F60F4D9426F52F7CD6ED6B7B163EC` |
| Installer size | `83125595` bytes |
| Installer last write | `2026-06-30 11:04:21` |
| Portable/no-install SHA-256 | `C54AA9F165AFFE3240829A8A2E1B08BFFAB7E37ECAEE70F7B080BF3E22AB2290` |
| Portable/no-install size | `82959846` bytes |
| Portable/no-install last write | `2026-06-30 12:28:28` |
