...
| Gate | Evidence |
| --- | --- |
| Final readiness | `output\codex-evidence\final-readiness-20260629092100.json` |
| Evidence selection | `output\codex-evidence\v15-final-readiness-evidence-manifest-20260629092100.json` |
| Delivery bundle | `output\delivery-bundles\v15-delivery-bundle-20260629092100-ready` |
| Current package launch smoke | `output\codex-evidence\package-launch-smoke-1782696056959.json` |
...
| Field | Value |
| --- | --- |
| Installer SHA-256 | `8CF15642ADC610C5C31443A6ABFCAC25E8F8CCE229E2618BD6ED5227A2525D4C` |
| Installer size | `83120186` bytes |
| Installer last write | `2026-06-29 09:20:44` |
| Portable/no-install SHA-256 | `F59859E3013FD0029B51304ABF1EE8474707E03583438DC5A25F3C043D9DC88A` |
| Portable/no-install size | `82954435` bytes |
| Portable/no-install last write | `2026-06-29 09:20:45` |
