...
| Gate | Evidence |
| --- | --- |
| Final readiness | `output\codex-evidence\final-readiness-20260625174302.json` |
| Evidence selection | `output\codex-evidence\v15-final-readiness-evidence-manifest-20260625174302.json` |
| Delivery bundle | `output\delivery-bundles\v15-delivery-bundle-20260625174302-ready` |
| Current package launch smoke | `output\codex-evidence\package-launch-smoke-1782380543563.json` |
...
| Installer size | `83111896` bytes |
| Installer last write | `2026-06-25 17:41:31` |
| Portable/no-install SHA-256 | `D048D03FB4FA8C1067B28A5086F86F9ACCE4AFB0AEEEB53F00574815D8123582` |
| Portable/no-install size | `82946141` bytes |
| Portable/no-install last write | `2026-06-25 17:41:33` |
