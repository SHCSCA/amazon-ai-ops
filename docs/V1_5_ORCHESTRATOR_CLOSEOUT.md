...
| Gate | Evidence |
| --- | --- |
| Final readiness | `output\codex-evidence\final-readiness-20260626101126.json` |
| Evidence selection | `output\codex-evidence\v15-final-readiness-evidence-manifest-20260626101126.json` |
| Delivery bundle | `output\delivery-bundles\v15-delivery-bundle-20260626101126-ready` |
| Current package launch smoke | `output\codex-evidence\package-launch-smoke-1782439851312.json` |
...
| Field | Value |
| --- | --- |
| Installer SHA-256 | `AFCDD9AD20B083BAB9166E92DB928080CA9AB8B8FD370FE3B89E7E69526AC6F4` |
| Installer size | `83115045` bytes |
| Installer last write | `2026-06-26 10:10:38` |
| Portable/no-install SHA-256 | `28F922D7B57BE0DEAB17475A201544ADF4FA564C7A891FD937CA3B3902AA4089` |
| Portable/no-install size | `82949298` bytes |
| Portable/no-install last write | `2026-06-26 10:10:40` |
