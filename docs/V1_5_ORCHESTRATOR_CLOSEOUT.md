...
| Gate | Evidence |
| --- | --- |
| Final readiness | `output\codex-evidence\final-readiness-20260630113912.json` |
| Evidence selection | `output\codex-evidence\v15-final-readiness-evidence-manifest-20260630113912.json` |
| Delivery bundle | `output\delivery-bundles\v15-delivery-bundle-20260630113912-ready` |
| Current package launch smoke | `output\codex-evidence\package-launch-smoke-1782790725443.json` |
...
| Field | Value |
| --- | --- |
| Installer SHA-256 | `04429AB14D0CD63D6EE1EBD819F5A40817671A466F804385BF8A215C4F4A99A5` |
| Installer size | `83125196` bytes |
| Installer last write | `2026-06-30 11:04:21` |
| Portable/no-install SHA-256 | `ED94611B067284D43377354FDD4170F3FE644613A21ADAE294E0E50BA9781083` |
| Portable/no-install size | `82959444` bytes |
