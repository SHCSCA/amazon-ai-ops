...
| Gate | Evidence |
| --- | --- |
| Final readiness | `output\codex-evidence\final-readiness-20260630110504.json` |
| Evidence selection | `output\codex-evidence\v15-final-readiness-evidence-manifest-20260630110504.json` |
| Delivery bundle | `output\delivery-bundles\v15-delivery-bundle-20260630110504-ready` |
| Current package launch smoke | `output\codex-evidence\package-launch-smoke-1782788680564.json` |
...
| Field | Value |
| --- | --- |
| Installer SHA-256 | `F21EC053822B6C420FB3A79CCA80992DB7E36A42A7DDF1A6630D821F5DC6E344` |
| Installer size | `83125050` bytes |
| Installer last write | `2026-06-30 11:04:21` |
| Portable/no-install SHA-256 | `07A4EB2D539E1ED28591E04B1317DC43A9E9670F9D1EBB721FF47788711117B4` |
| Portable/no-install size | `82959296` bytes |
| Portable/no-install last write | `2026-06-30 11:04:22` |
