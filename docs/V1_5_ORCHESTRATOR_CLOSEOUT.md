...
| Gate | Evidence |
| --- | --- |
| Final readiness | `output\codex-evidence\final-readiness-20260630112259.json` |
| Evidence selection | `output\codex-evidence\v15-final-readiness-evidence-manifest-20260630112259.json` |
| Delivery bundle | `output\delivery-bundles\v15-delivery-bundle-20260630112259-ready` |
| Current package launch smoke | `output\codex-evidence\package-launch-smoke-1782789750923.json` |
...
| Field | Value |
| --- | --- |
| Installer SHA-256 | `2D34CC0E72CADF1F351ABF8DE0B0ABA3E380CA54D903C1FFB493C30A17652F5A` |
| Installer size | `83125104` bytes |
| Installer last write | `2026-06-30 11:04:21` |
| Portable/no-install SHA-256 | `D2BF3C3B763002D42BFF787C7C907283B021AA7C6C4B941C6746A60AE9004524` |
| Portable/no-install size | `82959358` bytes |
