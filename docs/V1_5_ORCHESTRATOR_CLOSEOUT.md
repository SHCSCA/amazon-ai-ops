...
| Gate | Evidence |
| --- | --- |
| Final readiness | `output\codex-evidence\final-readiness-20260630160944.json` |
| Evidence selection | `output\codex-evidence\v15-final-readiness-evidence-manifest-20260630160944.json` |
| Delivery bundle | `output\delivery-bundles\v15-delivery-bundle-20260630160944-ready` |
| Current package launch smoke | `output\codex-evidence\package-launch-smoke-1782806934902.json` |
...
| Field | Value |
| --- | --- |
| Installer SHA-256 | `732CB393DF259EF0721BEA970AC73D38F00EADB32B1F9964031C88AB9CC1B6E9` |
| Installer size | `83128139` bytes |
| Installer last write | `2026-06-30 16:08:40` |
| Portable/no-install SHA-256 | `A57D03FAF1518C760D1ED6070C89E464CF6BB136F2F276FBA2ACE1588A449777` |
| Portable/no-install size | `82962390` bytes |
| Portable/no-install last write | `2026-06-30 16:08:41` |
