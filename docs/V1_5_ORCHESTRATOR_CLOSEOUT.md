...
| Gate | Evidence |
| --- | --- |
| Final readiness | `output\codex-evidence\final-readiness-20260626093820.json` |
| Evidence selection | `output\codex-evidence\v15-final-readiness-evidence-manifest-20260626093820.json` |
| Delivery bundle | `output\delivery-bundles\v15-delivery-bundle-20260626093820-ready` |
| Current package launch smoke | `output\codex-evidence\package-launch-smoke-1782437874064.json` |
...
| Installer size | `83114017` bytes |
| Installer last write | `2026-06-26 09:37:29` |
| Portable/no-install SHA-256 | `A1A4B89AF46F565C4F7B0396876D977BF925E81A9D4FB7C297B03E18BFA16A19` |
| Portable/no-install size | `82948264` bytes |
| Portable/no-install last write | `2026-06-26 09:37:31` |
