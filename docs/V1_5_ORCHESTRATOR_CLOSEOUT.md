...
| Gate | Evidence |
| --- | --- |
| Final readiness | `output\codex-evidence\final-readiness-20260626090719.json` |
| Evidence selection | `output\codex-evidence\v15-final-readiness-evidence-manifest-20260626090719.json` |
| Delivery bundle | `output\delivery-bundles\v15-delivery-bundle-20260626090719-ready` |
| Current package launch smoke | `output\codex-evidence\package-launch-smoke-1782436018463.json` |
...
| Installer size | `83113170` bytes |
| Installer last write | `2026-06-26 09:06:46` |
| Portable/no-install SHA-256 | `D286EB16EE2E895FE2562A41616F240C9864282F6EA405A5BDAC4B2C65C333AB` |
| Portable/no-install size | `82947415` bytes |
| Portable/no-install last write | `2026-06-26 09:06:48` |
