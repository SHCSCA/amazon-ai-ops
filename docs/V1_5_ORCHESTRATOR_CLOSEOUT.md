...
| Gate | Evidence |
| --- | --- |
| Final readiness | `output\codex-evidence\final-readiness-20260630170102.json` |
| Evidence selection | `output\codex-evidence\v15-final-readiness-evidence-manifest-20260630170102.json` |
| Delivery bundle | `output\delivery-bundles\v15-delivery-bundle-20260630170102-ready` |
| Current package launch smoke | `output\codex-evidence\package-launch-smoke-1782810017152.json` |
...
| Field | Value |
| --- | --- |
| Installer SHA-256 | `DC38BD91A0C7E3ECD7EFC3F1A05B29F9117C09853EA8566728CF4F757998A710` |
| Installer size | `83128516` bytes |
| Installer last write | `2026-06-30 16:42:42` |
| Portable/no-install SHA-256 | `5BDE5C32D256EC4E8D122107D6E4FF8EBD11661D3310C78ABD9C79404C7C43A9` |
| Portable/no-install size | `82962763` bytes |
| Portable/no-install last write | `2026-06-30 17:00:04` |
