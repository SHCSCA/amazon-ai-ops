...
| Gate | Evidence |
| --- | --- |
| Final readiness | `output\codex-evidence\final-readiness-20260626141045.json` |
| Evidence selection | `output\codex-evidence\v15-final-readiness-evidence-manifest-20260626141045.json` |
| Delivery bundle | `output\delivery-bundles\v15-delivery-bundle-20260626141045-ready` |
| Current package launch smoke | `output\codex-evidence\package-launch-smoke-1782454222875.json` |
...
| Installer size | `83115843` bytes |
| Installer last write | `2026-06-26 14:10:08` |
| Portable/no-install SHA-256 | `98D508CAC94B044A1C483F2DB8375AE0CD07AC6575039BF7A57FFCC872C44687` |
| Portable/no-install size | `82950087` bytes |
| Portable/no-install last write | `2026-06-26 14:10:09` |
