...
| Gate | Evidence |
| --- | --- |
| Final readiness | `output\codex-evidence\final-readiness-20260630150210.json` |
| Evidence selection | `output\codex-evidence\v15-final-readiness-evidence-manifest-20260630150210.json` |
| Delivery bundle | `output\delivery-bundles\v15-delivery-bundle-20260630150210-ready` |
| Current package launch smoke | `output\codex-evidence\package-launch-smoke-1782802903677.json` |
...
| Field | Value |
| --- | --- |
| Installer SHA-256 | `67D4E6C1C8CBB8E9163C33FA6815E706463F905F84D24AA0AD15968E17693037` |
| Installer size | `83127137` bytes |
| Installer last write | `2026-06-30 14:43:39` |
| Portable/no-install SHA-256 | `89EA336FDD8D53D803119D4298DA6B485FC53B070190C7BD812B7DD30846B502` |
| Portable/no-install size | `82961386` bytes |
| Portable/no-install last write | `2026-06-30 15:01:33` |
