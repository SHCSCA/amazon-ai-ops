...
| Gate | Evidence |
| --- | --- |
| Final readiness | `output\codex-evidence\final-readiness-20260630152422.json` |
| Evidence selection | `output\codex-evidence\v15-final-readiness-evidence-manifest-20260630152422.json` |
| Delivery bundle | `output\delivery-bundles\v15-delivery-bundle-20260630152422-ready` |
| Current package launch smoke | `output\codex-evidence\package-launch-smoke-1782804235167.json` |
...
| Field | Value |
| --- | --- |
| Installer SHA-256 | `EDCBFEAADD2CC49867E4B0B0F59EA08498D7F4A9A001C2C78BE7FD168975C7EF` |
| Installer size | `83127318` bytes |
| Installer last write | `2026-06-30 15:23:43` |
| Portable/no-install SHA-256 | `D0C2AA1364C91E9449BBFA6B714598751B145CFB0BD193A882F595A2F498F928` |
| Portable/no-install size | `82961572` bytes |
| Portable/no-install last write | `2026-06-30 15:23:44` |
