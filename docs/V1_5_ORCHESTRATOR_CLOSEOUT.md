...
| Gate | Evidence |
| --- | --- |
| Final readiness | `output\codex-evidence\final-readiness-20260625163330.json` |
| Evidence selection | `output\codex-evidence\v15-final-readiness-evidence-manifest-20260625163330.json` |
| Delivery bundle | `output\delivery-bundles\v15-delivery-bundle-20260625163330-ready` |
| Current package launch smoke | `output\codex-evidence\package-launch-smoke-1782376349240.json` |
...
| Installer size | `83109485` bytes |
| Installer last write | `2026-06-25 16:32:17` |
| Portable/no-install SHA-256 | `D5EE069593409D76B895F8A201935BEA9FDF28FEA776BFABD676B5AA2EBAECA8` |
| Portable/no-install size | `82943732` bytes |
| Portable/no-install last write | `2026-06-25 16:32:19` |
