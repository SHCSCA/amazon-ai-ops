...
| Gate | Evidence |
| --- | --- |
| Final readiness | `output\codex-evidence\final-readiness-20260626094600.json` |
| Evidence selection | `output\codex-evidence\v15-final-readiness-evidence-manifest-20260626094600.json` |
| Delivery bundle | `output\delivery-bundles\v15-delivery-bundle-20260626094600-ready` |
| Current package launch smoke | `output\codex-evidence\package-launch-smoke-1782438338685.json` |
...
| Field | Value |
| --- | --- |
| Installer SHA-256 | `19E9DCD512E435F0F6A8FFB44B1ECF6791B04C96491F7827FE8AA425D062BB00` |
| Installer size | `83114200` bytes |
| Installer last write | `2026-06-26 09:45:20` |
| Portable/no-install SHA-256 | `D4017D145EC2E1E78254969B1F7C67A79CC4C90C79DE5E5040EAACD92DA3AE3F` |
| Portable/no-install size | `82948453` bytes |
| Portable/no-install last write | `2026-06-26 09:45:22` |
