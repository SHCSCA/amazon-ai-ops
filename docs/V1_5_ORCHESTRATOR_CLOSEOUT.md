...
| Gate | Evidence |
| --- | --- |
| Final readiness | `output\codex-evidence\final-readiness-20260626145003.json` |
| Evidence selection | `output\codex-evidence\v15-final-readiness-evidence-manifest-20260626145003.json` |
| Delivery bundle | `output\delivery-bundles\v15-delivery-bundle-20260626145003-ready` |
| Current package launch smoke | `output\codex-evidence\package-launch-smoke-1782456571922.json` |
...
| Field | Value |
| --- | --- |
| Installer SHA-256 | `692A859F766389DF93F2634BFF1A6693A461DE7572D17ED71A217A8D3DFE8AC8` |
| Installer size | `83117066` bytes |
| Installer last write | `2026-06-26 14:49:21` |
| Portable/no-install SHA-256 | `99D0CAF1EEA586B8814CC692036A6C86280DB6A90218F407E196DE9FFDD75B6B` |
| Portable/no-install size | `82951317` bytes |
| Portable/no-install last write | `2026-06-26 14:49:23` |
