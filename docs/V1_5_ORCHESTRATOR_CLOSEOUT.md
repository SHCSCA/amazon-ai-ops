...
| Gate | Evidence |
| --- | --- |
| Final readiness | `output\codex-evidence\final-readiness-20260629084900.json` |
| Evidence selection | `output\codex-evidence\v15-final-readiness-evidence-manifest-20260629084900.json` |
| Delivery bundle | `output\delivery-bundles\v15-delivery-bundle-20260629084900-ready` |
| Current package launch smoke | `output\codex-evidence\package-launch-smoke-1782694156238.json` |
...
| Field | Value |
| --- | --- |
| Installer SHA-256 | `ED3AC8F011360A0C6005E60BF58522C2D2D07C985AC70F3FAC65F69FD34298CC` |
| Installer size | `83120102` bytes |
| Installer last write | `2026-06-29 08:48:55` |
| Portable/no-install SHA-256 | `7BD798183F9882A1CE5A3A98354EAD3A2AA4C697AC0E38925522396EEA7316C5` |
| Portable/no-install size | `82954346` bytes |
| Portable/no-install last write | `2026-06-29 08:48:58` |
