...
| Gate | Evidence |
| --- | --- |
| Final readiness | `output\codex-evidence\final-readiness-20260629123536.json` |
| Evidence selection | `output\codex-evidence\v15-final-readiness-evidence-manifest-20260629123536.json` |
| Delivery bundle | `output\delivery-bundles\v15-delivery-bundle-20260629123536-ready` |
| Current package launch smoke | `output\codex-evidence\package-launch-smoke-1782707704476.json` |
...
| Field | Value |
| --- | --- |
| Installer SHA-256 | `D6AB786FD090A081E370E80EAC330058AA8F1BF58510313C36D3633E8591288B` |
| Installer size | `83121425` bytes |
| Installer last write | `2026-06-29 12:34:52` |
| Portable/no-install SHA-256 | `C5F2300E468649F98498AD4EC5D326B2CD30431495CCD63378A0D698E2B09F2F` |
| Portable/no-install size | `82955675` bytes |
| Portable/no-install last write | `2026-06-29 12:34:54` |
