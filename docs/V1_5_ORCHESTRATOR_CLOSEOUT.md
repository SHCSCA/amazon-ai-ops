...
| Gate | Evidence |
| --- | --- |
| Final readiness | `output\codex-evidence\final-readiness-20260625171348.json` |
| Evidence selection | `output\codex-evidence\v15-final-readiness-evidence-manifest-20260625171348.json` |
| Delivery bundle | `output\delivery-bundles\v15-delivery-bundle-20260625171348-ready` |
| Current package launch smoke | `output\codex-evidence\package-launch-smoke-1782378785875.json` |
...
| Portable/no-install size | `82945412` bytes |
