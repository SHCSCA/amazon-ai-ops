...
| Gate | Evidence |
| --- | --- |
| Final readiness | `output\codex-evidence\final-readiness-20260629112616.json` |
| Evidence selection | `output\codex-evidence\v15-final-readiness-evidence-manifest-20260629112616.json` |
| Delivery bundle | `output\delivery-bundles\v15-delivery-bundle-20260629112616-ready` |
| Current package launch smoke | `output\codex-evidence\package-launch-smoke-1782703552957.json` |
...
| Field | Value |
| --- | --- |
| Installer SHA-256 | `625CA199821F47599C36C24107208DE72C554EBC54941831ABCD0F7043D9F8D5` |
| Installer size | `83120619` bytes |
| Installer last write | `2026-06-29 11:25:40` |
| Portable/no-install SHA-256 | `5768F01E3D7B62C699D2D49CA6197C24DF6C9DE95AECF3CBF4004B0112DEFB3E` |
| Portable/no-install size | `82954869` bytes |
| Portable/no-install last write | `2026-06-29 11:25:42` |
