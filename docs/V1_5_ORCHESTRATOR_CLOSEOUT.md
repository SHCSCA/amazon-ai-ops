...
| Gate | Evidence |
| --- | --- |
| Final readiness | `output\codex-evidence\final-readiness-20260629152416.json` |
| Evidence selection | `output\codex-evidence\v15-final-readiness-evidence-manifest-20260629152416.json` |
| Delivery bundle | `output\delivery-bundles\v15-delivery-bundle-20260629152416-ready` |
| Current package launch smoke | `output\codex-evidence\package-launch-smoke-1782717803931.json` |
...
| Field | Value |
| --- | --- |
| Installer SHA-256 | `EAF21F2B7C06BF3816E781CA598FB9A36F453444FB9A4DE2704F7C8D8D9EEABF` |
| Installer size | `83122490` bytes |
| Installer last write | `2026-06-29 15:22:59` |
| Portable/no-install SHA-256 | `C7EF69E8356D1C6C0C47DD6176B6D439A3180C71CF4BC449003E2666E5F829FE` |
| Portable/no-install size | `82956743` bytes |
| Portable/no-install last write | `2026-06-29 15:23:00` |
