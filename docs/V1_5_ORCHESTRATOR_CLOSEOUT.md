...
| Gate | Evidence |
| --- | --- |
| Final readiness | `output\codex-evidence\final-readiness-20260626171442.json` |
| Evidence selection | `output\codex-evidence\v15-final-readiness-evidence-manifest-20260626171442.json` |
| Delivery bundle | `output\delivery-bundles\v15-delivery-bundle-20260626171442-ready` |
| Current package launch smoke | `output\codex-evidence\package-launch-smoke-1782465291064.json` |
...
| Field | Value |
| --- | --- |
| Installer SHA-256 | `ED7CE125EBE4DF62EA1C5F06D703D6CF88528539AF9143DC79EAC42D17160189` |
| Installer size | `83119829` bytes |
| Installer last write | `2026-06-26 17:14:40` |
| Portable/no-install SHA-256 | `08C593FB30C19DCBC449C9E9CA1599B18BCC268070BD8C00B72CE6998F8A33F0` |
| Portable/no-install size | `82954078` bytes |
| Portable/no-install last write | `2026-06-26 17:14:42` |
