...
| Gate | Evidence |
| --- | --- |
| Final readiness | `output\codex-evidence\final-readiness-20260629153854.json` |
| Evidence selection | `output\codex-evidence\v15-final-readiness-evidence-manifest-20260629153854.json` |
| Delivery bundle | `output\delivery-bundles\v15-delivery-bundle-20260629153854-ready` |
| Current package launch smoke | `output\codex-evidence\package-launch-smoke-1782718706937.json` |
...
| Field | Value |
| --- | --- |
| Installer SHA-256 | `4BBFEFBF1FAE2F7951C853FE9A0319DBDD3C2AD64CFBC6D150A982B8DC40765A` |
| Installer size | `83122803` bytes |
| Installer last write | `2026-06-29 15:38:11` |
| Portable/no-install SHA-256 | `D3C10A51EA1CAD47AF11A922F92E9DD14A35C6CC601761055C9A0F10D75E82F8` |
| Portable/no-install size | `82957051` bytes |
| Portable/no-install last write | `2026-06-29 15:38:12` |
