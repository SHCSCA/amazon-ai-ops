...
| Gate | Evidence |
| --- | --- |
| Final readiness | `output\codex-evidence\final-readiness-20260630144400.json` |
| Evidence selection | `output\codex-evidence\v15-final-readiness-evidence-manifest-20260630144400.json` |
| Delivery bundle | `output\delivery-bundles\v15-delivery-bundle-20260630144400-ready` |
| Current package launch smoke | `output\codex-evidence\package-launch-smoke-1782801832587.json` |
...
| Field | Value |
| --- | --- |
| Installer SHA-256 | `4CD831C9E7A2C6AF9B84E989894E596039DE71A580CDAD83472663840814745C` |
| Installer size | `83126959` bytes |
| Installer last write | `2026-06-30 14:43:39` |
| Portable/no-install SHA-256 | `8696F23C4B91875745B46D4EF0CB99436D3A21B2B0E9770FB10D0E244BB86D15` |
| Portable/no-install size | `82961210` bytes |
| Portable/no-install last write | `2026-06-30 14:43:41` |
