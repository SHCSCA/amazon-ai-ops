...
| Gate | Evidence |
| --- | --- |
| Final readiness | `output\codex-evidence\final-readiness-20260625162200.json` |
| Evidence selection | `output\codex-evidence\v15-final-readiness-evidence-manifest-20260625162200.json` |
| Delivery bundle | `output\delivery-bundles\v15-delivery-bundle-20260625162200-ready` |
| Current package launch smoke | `output\codex-evidence\package-launch-smoke-1782375663894.json` |
...
| Installer size | `83108802` bytes |
| Installer last write | `2026-06-25 16:20:52` |
| Portable/no-install SHA-256 | `3F8F7F0DBA00124DB171644E5AD9B5221CD5D3A6CF7F86BDE32293A2107AB8B5` |
| Portable/no-install size | `82943049` bytes |
| Portable/no-install last write | `2026-06-25 16:20:54` |
