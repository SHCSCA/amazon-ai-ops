...
| Gate | Evidence |
| --- | --- |
| Final readiness | `output\codex-evidence\final-readiness-20260629113731.json` |
| Evidence selection | `output\codex-evidence\v15-final-readiness-evidence-manifest-20260629113731.json` |
| Delivery bundle | `output\delivery-bundles\v15-delivery-bundle-20260629113731-ready` |
| Current package launch smoke | `output\codex-evidence\package-launch-smoke-1782704222536.json` |
...
| Field | Value |
| --- | --- |
| Installer SHA-256 | `4C38AECD9EF08F12F9C0E3B56FBE76299BABD2EE11A4E5A5749D651617C637C7` |
| Installer size | `83120693` bytes |
| Installer last write | `2026-06-29 11:36:51` |
| Portable/no-install SHA-256 | `0FD64A2ADA8F37F9E820D5ADB289B89FF85E358100261D849C9C3B64C1809E7B` |
| Portable/no-install size | `82954945` bytes |
| Portable/no-install last write | `2026-06-29 11:36:52` |
