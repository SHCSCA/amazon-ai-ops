...
| Gate | Evidence |
| --- | --- |
| Final readiness | `output\codex-evidence\final-readiness-20260630121322.json` |
| Evidence selection | `output\codex-evidence\v15-final-readiness-evidence-manifest-20260630121322.json` |
| Delivery bundle | `output\delivery-bundles\v15-delivery-bundle-20260630121322-ready` |
| Current package launch smoke | `output\codex-evidence\package-launch-smoke-1782792777516.json` |
...
| Field | Value |
| --- | --- |
| Installer SHA-256 | `ECD45F32D1055B6F35BD049F079641ABA087E78D7AB2793258A66AFCD8B39407` |
| Installer size | `83125523` bytes |
| Installer last write | `2026-06-30 11:04:21` |
| Portable/no-install SHA-256 | `790B8E586E3AEF81D8DABE3CE81CA81AE40D36E6A18FBB592482ECD26A7EFD8F` |
| Portable/no-install size | `82959772` bytes |
