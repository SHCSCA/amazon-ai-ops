...
| Gate | Evidence |
| --- | --- |
| Final readiness | `output\codex-evidence\final-readiness-20260629111137.json` |
| Evidence selection | `output\codex-evidence\v15-final-readiness-evidence-manifest-20260629111137.json` |
| Delivery bundle | `output\delivery-bundles\v15-delivery-bundle-20260629111137-ready` |
| Current package launch smoke | `output\codex-evidence\package-launch-smoke-1782702602911.json` |
...
| Field | Value |
| --- | --- |
| Installer SHA-256 | `8659AA0B3012CB590163888E9314B53973DDD0BA586B99200E215D02AE3EEAA2` |
| Installer size | `83120600` bytes |
| Installer last write | `2026-06-29 10:53:18` |
| Portable/no-install SHA-256 | `D136E70838E6326EA61E30E42D56BE92FF879B9F39BA1F40C7C63F73016C1A3D` |
| Portable/no-install size | `82954847` bytes |
| Portable/no-install last write | `2026-06-29 10:53:20` |
