...
| Gate | Evidence |
| --- | --- |
| Final readiness | `output\codex-evidence\final-readiness-20260626154925.json` |
| Evidence selection | `output\codex-evidence\v15-final-readiness-evidence-manifest-20260626154925.json` |
| Delivery bundle | `output\delivery-bundles\v15-delivery-bundle-20260626154925-ready` |
| Current package launch smoke | `output\codex-evidence\package-launch-smoke-1782460113007.json` |
...
| Installer size | `83118320` bytes |
| Installer last write | `2026-06-26 15:48:23` |
| Portable/no-install SHA-256 | `33D385BFC7F48862ECE509BBA149EDF9E94B2E5ADA3D1030C8511ABBCB1883A6` |
| Portable/no-install size | `82952565` bytes |
| Portable/no-install last write | `2026-06-26 15:48:25` |
