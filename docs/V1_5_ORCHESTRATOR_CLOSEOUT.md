...
| Gate | Evidence |
| --- | --- |
| Final readiness | `output\codex-evidence\final-readiness-20260625170200.json` |
| Evidence selection | `output\codex-evidence\v15-final-readiness-evidence-manifest-20260625170200.json` |
| Delivery bundle | `output\delivery-bundles\v15-delivery-bundle-20260625170200-ready` |
| Current package launch smoke | `output\codex-evidence\package-launch-smoke-1782378054115.json` |
...
| Installer size | `83111022` bytes |
| Installer last write | `2026-06-25 17:00:42` |
| Portable/no-install SHA-256 | `BF677EBD3246636545589EA2302AD4C07CC24E696F292700BCEE2F12F1F19C10` |
| Portable/no-install size | `82945269` bytes |
| Portable/no-install last write | `2026-06-25 17:00:43` |
