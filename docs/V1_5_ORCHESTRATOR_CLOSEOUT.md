...
| Gate | Evidence |
| --- | --- |
| Final readiness | `output\codex-evidence\final-readiness-20260630164400.json` |
| Evidence selection | `output\codex-evidence\v15-final-readiness-evidence-manifest-20260630164400.json` |
| Delivery bundle | `output\delivery-bundles\v15-delivery-bundle-20260630164400-ready` |
| Current package launch smoke | `output\codex-evidence\package-launch-smoke-1782809011504.json` |
...
| Field | Value |
| --- | --- |
| Installer SHA-256 | `315147492889E784F201D65366C8F16DBC118F52044C91DBFEDC06BD4DD4CB94` |
| Installer size | `83128346` bytes |
| Installer last write | `2026-06-30 16:42:42` |
| Portable/no-install SHA-256 | `B5E2A2DAF2DFB58133BC9FF38E116E47FB5CB073FA295BFA8E5ECB517C23CDC4` |
| Portable/no-install size | `82962592` bytes |
| Portable/no-install last write | `2026-06-30 16:42:43` |
