...
| Gate | Evidence |
| --- | --- |
| Final readiness | `output\codex-evidence\final-readiness-20260626164257.json` |
| Evidence selection | `output\codex-evidence\v15-final-readiness-evidence-manifest-20260626164257.json` |
| Delivery bundle | `output\delivery-bundles\v15-delivery-bundle-20260626164257-ready` |
| Current package launch smoke | `output\codex-evidence\package-launch-smoke-1782463345838.json` |
...
| Field | Value |
| --- | --- |
| Installer SHA-256 | `2F887DDD278428B6C3E63A7892AD744A72D0EF7B7EBFDAD98F4B93290656E8A7` |
| Installer size | `83118713` bytes |
| Installer last write | `2026-06-26 16:42:15` |
| Portable/no-install SHA-256 | `C1FBA55B52FFD457B66D9BC079BFF2F10FEF65536BFA271B246EB7B66FD1202E` |
| Portable/no-install size | `82952962` bytes |
| Portable/no-install last write | `2026-06-26 16:42:17` |
