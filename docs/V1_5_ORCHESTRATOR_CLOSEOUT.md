...
| Gate | Evidence |
| --- | --- |
| Final readiness | `output\codex-evidence\final-readiness-20260629100000.json` |
| Evidence selection | `output\codex-evidence\v15-final-readiness-evidence-manifest-20260629100000.json` |
| Delivery bundle | `output\delivery-bundles\v15-delivery-bundle-20260629100000-ready` |
| Current package launch smoke | `output\codex-evidence\package-launch-smoke-1782698352901.json` |
...
| Field | Value |
| --- | --- |
| Installer SHA-256 | `CC50549E290F15A4E79F2A1F5EE4F5B373943A6AABE02DCAA8507BE9A316CE40` |
| Installer size | `83120352` bytes |
| Installer last write | `2026-06-29 09:59:00` |
| Portable/no-install SHA-256 | `94F89099A9F812AEEED829A93C72400DFAF723A0DC347D1F1DEDDB1CE3207BCF` |
| Portable/no-install size | `82954602` bytes |
| Portable/no-install last write | `2026-06-29 09:59:01` |
