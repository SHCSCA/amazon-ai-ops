...
| Gate | Evidence |
| --- | --- |
| Final readiness | `output\codex-evidence\final-readiness-20260630140730.json` |
| Evidence selection | `output\codex-evidence\v15-final-readiness-evidence-manifest-20260630140730.json` |
| Delivery bundle | `output\delivery-bundles\v15-delivery-bundle-20260630140730-ready` |
| Current package launch smoke | `output\codex-evidence\package-launch-smoke-1782799636488.json` |
...
| Field | Value |
| --- | --- |
| Installer SHA-256 | `CF208E87F9CB2318CEC1B77909AF7FB47DB54AE378B36239B5B7C9F71C318F82` |
| Installer size | `83126521` bytes |
| Installer last write | `2026-06-30 12:54:54` |
| Portable/no-install SHA-256 | `8CF6C7878E13EF3BE637A17E46468E513478593BF3EDCFF526A11E3613CEF61D` |
| Portable/no-install size | `82960768` bytes |
