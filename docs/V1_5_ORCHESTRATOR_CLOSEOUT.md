...
| Gate | Evidence |
| --- | --- |
| Final readiness | `output\codex-evidence\final-readiness-20260626110440.json` |
| Evidence selection | `output\codex-evidence\v15-final-readiness-evidence-manifest-20260626110440.json` |
| Delivery bundle | `output\delivery-bundles\v15-delivery-bundle-20260626110440-ready` |
| Current package launch smoke | `output\codex-evidence\package-launch-smoke-1782443058648.json` |
...
| Field | Value |
| --- | --- |
| Installer SHA-256 | `47C43F942E2EFB2AB4495207E90B881A3993BCBB1081305D0DDE0DBEEDB487E3` |
| Installer size | `83115666` bytes |
| Installer last write | `2026-06-26 11:04:06` |
| Portable/no-install SHA-256 | `9596FFDE2B9244E628A7B22693BF19DFD418C954973938EFEA32A8147EB2D765` |
| Portable/no-install size | `82949917` bytes |
| Portable/no-install last write | `2026-06-26 11:04:08` |
