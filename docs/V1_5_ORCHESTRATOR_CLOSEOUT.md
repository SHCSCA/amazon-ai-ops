...
| Gate | Evidence |
| --- | --- |
| Final readiness | `output\codex-evidence\final-readiness-20260626092219.json` |
| Evidence selection | `output\codex-evidence\v15-final-readiness-evidence-manifest-20260626092219.json` |
| Delivery bundle | `output\delivery-bundles\v15-delivery-bundle-20260626092219-ready` |
| Current package launch smoke | `output\codex-evidence\package-launch-smoke-1782436918323.json` |
...
| Installer size | `83113962` bytes |
| Installer last write | `2026-06-26 09:21:38` |
| Portable/no-install SHA-256 | `C5DD7D0DA09E5C0618B96AAA9CD0AA7D246A502A01E9C7C6FE71C1692D56E898` |
| Portable/no-install size | `82948216` bytes |
| Portable/no-install last write | `2026-06-26 09:21:39` |
