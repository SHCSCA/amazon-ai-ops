...
| Gate | Evidence |
| --- | --- |
| Final readiness | `output\codex-evidence\final-readiness-20260629121536.json` |
| Evidence selection | `output\codex-evidence\v15-final-readiness-evidence-manifest-20260629121536.json` |
| Delivery bundle | `output\delivery-bundles\v15-delivery-bundle-20260629121536-ready` |
| Current package launch smoke | `output\codex-evidence\package-launch-smoke-1782706505494.json` |
...
| Field | Value |
| --- | --- |
| Installer SHA-256 | `8C98439503857A06560BE390D6EA75F0270985A8B6F8BF8C1090476F39E85010` |
| Installer size | `83121338` bytes |
| Installer last write | `2026-06-29 12:14:52` |
| Portable/no-install SHA-256 | `BC675D3AAAD02D925AEA5F45736E198DA9E5B2E20E12CAB3945BBD48F518F7CB` |
| Portable/no-install size | `82955589` bytes |
| Portable/no-install last write | `2026-06-29 12:14:54` |
