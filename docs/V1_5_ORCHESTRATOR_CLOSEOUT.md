...
| Gate | Evidence |
| --- | --- |
| Final readiness | `output\codex-evidence\final-readiness-20260629102000.json` |
| Evidence selection | `output\codex-evidence\v15-final-readiness-evidence-manifest-20260629102000.json` |
| Delivery bundle | `output\delivery-bundles\v15-delivery-bundle-20260629102000-ready` |
| Current package launch smoke | `output\codex-evidence\package-launch-smoke-1782699544352.json` |
...
| Field | Value |
| --- | --- |
| Installer SHA-256 | `F1DFE14A1BAA7160EBBE38CE8C8238CBBDBF539A4937675AC5EFEA09EDB689AB` |
| Installer size | `83120400` bytes |
| Installer last write | `2026-06-29 10:18:49` |
| Portable/no-install SHA-256 | `B8F535EB34D26452DFF8FF7FF3FDC679CEDB316983F76DA2F5CFEB5D44D161E6` |
| Portable/no-install size | `82954653` bytes |
| Portable/no-install last write | `2026-06-29 10:18:50` |
