...
| Gate | Evidence |
| --- | --- |
| Final readiness | `output\codex-evidence\final-readiness-20260630142700.json` |
| Evidence selection | `output\codex-evidence\v15-final-readiness-evidence-manifest-20260630142700.json` |
| Delivery bundle | `output\delivery-bundles\v15-delivery-bundle-20260630142700-ready` |
| Current package launch smoke | `output\codex-evidence\package-launch-smoke-1782800794443.json` |
...
| Portable/no-install size | `82961036` bytes |
