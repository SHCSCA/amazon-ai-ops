...
| Gate | Evidence |
| --- | --- |
| Final readiness | `output\codex-evidence\final-readiness-20260626102855.json` |
| Evidence selection | `output\codex-evidence\v15-final-readiness-evidence-manifest-20260626102855.json` |
| Delivery bundle | `output\delivery-bundles\v15-delivery-bundle-20260626102855-ready` |
| Current package launch smoke | `output\codex-evidence\package-launch-smoke-1782440943719.json` |
...
| Field | Value |
| --- | --- |
| Installer SHA-256 | `603AC1F83C854491E84F37F9788CF50E3AA1BC62936C0B39DAF50EC2FC4F5E4D` |
| Installer size | `83115481` bytes |
| Installer last write | `2026-06-26 10:28:44` |
| Portable/no-install SHA-256 | `608D6DC7228EF3787622A33145A99657220444CE03DBD521BFA16AFF41DE52E5` |
| Portable/no-install size | `82949727` bytes |
| Portable/no-install last write | `2026-06-26 10:28:46` |
