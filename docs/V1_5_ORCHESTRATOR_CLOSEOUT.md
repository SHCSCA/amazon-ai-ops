...
| Gate | Evidence |
| --- | --- |
| Final readiness | `output\codex-evidence\final-readiness-20260630095957.json` |
| Evidence selection | `output\codex-evidence\v15-final-readiness-evidence-manifest-20260630095957.json` |
| Delivery bundle | `output\delivery-bundles\v15-delivery-bundle-20260630095957-ready` |
| Current package launch smoke | `output\codex-evidence\package-launch-smoke-1782784773664.json` |
...
| Field | Value |
| --- | --- |
| Installer SHA-256 | `948CAD639E5A22B92B10DCBDE2B52A1A92AE40B20C88A453549AA0E33DD4BFD8` |
| Installer size | `83123933` bytes |
| Installer last write | `2026-06-30 09:59:12` |
| Portable/no-install SHA-256 | `838D012F93A3806E5197289FAB4827477B2552D217437B43F53DBA02C0B4A4D5` |
| Portable/no-install size | `82958182` bytes |
| Portable/no-install last write | `2026-06-30 09:59:14` |
