...
| Gate | Evidence |
| --- | --- |
| Final readiness | `output\codex-evidence\final-readiness-20260626101822.json` |
| Evidence selection | `output\codex-evidence\v15-final-readiness-evidence-manifest-20260626101822.json` |
| Delivery bundle | `output\delivery-bundles\v15-delivery-bundle-20260626101822-ready` |
| Current package launch smoke | `output\codex-evidence\package-launch-smoke-1782440278624.json` |
...
| Field | Value |
| --- | --- |
| Installer SHA-256 | `2973E0A43364493E680085E327714689CDEA6DDF60F3CD23C2857942A804A0E7` |
| Installer size | `83115127` bytes |
| Installer last write | `2026-06-26 10:17:46` |
| Portable/no-install SHA-256 | `CEE179511021D0C670E7716704D83ACF98AF6C7899D7C9EE3EEF3B98D802E22E` |
| Portable/no-install size | `82949380` bytes |
| Portable/no-install last write | `2026-06-26 10:17:48` |
