...
| Gate | Evidence |
| --- | --- |
| Final readiness | `output\codex-evidence\final-readiness-20260629094430.json` |
| Evidence selection | `output\codex-evidence\v15-final-readiness-evidence-manifest-20260629094430.json` |
| Delivery bundle | `output\delivery-bundles\v15-delivery-bundle-20260629094430-ready` |
| Current package launch smoke | `output\codex-evidence\package-launch-smoke-1782697434133.json` |
...
| Field | Value |
| --- | --- |
| Installer SHA-256 | `39C97B57320E1D9FFBC9B4F6E88BBDAFBD1D8140A03E11976A73987E66ED240D` |
| Installer size | `83120346` bytes |
| Installer last write | `2026-06-29 09:43:40` |
| Portable/no-install SHA-256 | `4859A002216E3970CEBB0A10A671E5E7B7B7CF5C72A9C0794C1B07BC835949CE` |
| Portable/no-install size | `82954595` bytes |
| Portable/no-install last write | `2026-06-29 09:43:42` |
