...
| Gate | Evidence |
| --- | --- |
| Final readiness | `output\codex-evidence\final-readiness-20260626143350.json` |
| Evidence selection | `output\codex-evidence\v15-final-readiness-evidence-manifest-20260626143350.json` |
| Delivery bundle | `output\delivery-bundles\v15-delivery-bundle-20260626143350-ready` |
| Current package launch smoke | `output\codex-evidence\package-launch-smoke-1782455600078.json` |
...
| Field | Value |
| --- | --- |
| Installer SHA-256 | `BFA9886DEC7C1AFA3390615F2249108155467A6E20E5205F42889C405E118F37` |
| Installer size | `83116481` bytes |
| Installer last write | `2026-06-26 14:33:09` |
| Portable/no-install SHA-256 | `F6F854A7755431905A91B2A7B298F2574BE4FEC067594387BFD28EEF6D9F6E28` |
| Portable/no-install size | `82950732` bytes |
| Portable/no-install last write | `2026-06-26 14:33:10` |
