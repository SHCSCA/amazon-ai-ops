...
| Gate | Evidence |
| --- | --- |
| Final readiness | `output\codex-evidence\final-readiness-20260626104249.json` |
| Evidence selection | `output\codex-evidence\v15-final-readiness-evidence-manifest-20260626104249.json` |
| Delivery bundle | `output\delivery-bundles\v15-delivery-bundle-20260626104249-ready` |
| Current package launch smoke | `output\codex-evidence\package-launch-smoke-1782441741424.json` |
...
| Field | Value |
| --- | --- |
| Installer SHA-256 | `E697EACBA894F977C9D2F6D5EE4F80D6905DD2B2AEEDB39FA58DBC29CEDED045` |
| Installer size | `83115494` bytes |
| Installer last write | `2026-06-26 10:42:12` |
| Portable/no-install SHA-256 | `6EA6CF05D94380626B551CE15F6D3C8C89421B3BD3D09ADA68DE71C25A28B765` |
| Portable/no-install size | `82949741` bytes |
| Portable/no-install last write | `2026-06-26 10:42:14` |
