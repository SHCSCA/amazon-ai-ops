...
| Gate | Evidence |
| --- | --- |
| Final readiness | `output\codex-evidence\final-readiness-20260629130723.json` |
| Evidence selection | `output\codex-evidence\v15-final-readiness-evidence-manifest-20260629130723.json` |
| Delivery bundle | `output\delivery-bundles\v15-delivery-bundle-20260629130723-ready` |
| Current package launch smoke | `output\codex-evidence\package-launch-smoke-1782709596136.json` |
...
| Field | Value |
| --- | --- |
| Installer SHA-256 | `155C844E164EF938C8DD110133E2EB6F4552F19C0A299EC86DD8D44F355EB685` |
| Installer size | `83121789` bytes |
| Installer last write | `2026-06-29 12:48:04` |
| Portable/no-install SHA-256 | `B3629B984CC9BCCE515419C182220FF700C22DA1BCDBD95F53650F3B90F1454A` |
| Portable/no-install size | `82956038` bytes |
