...
| Gate | Evidence |
| --- | --- |
| Final readiness | `output\codex-evidence\final-readiness-20260629104000.json` |
| Evidence selection | `output\codex-evidence\v15-final-readiness-evidence-manifest-20260629104000.json` |
| Delivery bundle | `output\delivery-bundles\v15-delivery-bundle-20260629104000-ready` |
| Current package launch smoke | `output\codex-evidence\package-launch-smoke-1782700727209.json` |
...
| Field | Value |
| --- | --- |
| Installer SHA-256 | `66472D5DB5C3B86FF6625B5D8C1609AB06438922E130FE5E7D09110681106814` |
| Installer size | `83120492` bytes |
| Installer last write | `2026-06-29 10:38:32` |
| Portable/no-install SHA-256 | `C468452FEF393DF144364DAB6B6823E9C314769A6CAD88996282306105BEE69B` |
| Portable/no-install size | `82954743` bytes |
| Portable/no-install last write | `2026-06-29 10:38:34` |
