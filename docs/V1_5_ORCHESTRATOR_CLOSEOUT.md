...
| Gate | Evidence |
| --- | --- |
| Final readiness | `output\codex-evidence\final-readiness-20260630104444.json` |
| Evidence selection | `output\codex-evidence\v15-final-readiness-evidence-manifest-20260630104444.json` |
| Delivery bundle | `output\delivery-bundles\v15-delivery-bundle-20260630104444-ready` |
| Current package launch smoke | `output\codex-evidence\package-launch-smoke-1782787443467.json` |
...
| Field | Value |
| --- | --- |
| Installer SHA-256 | `E9455273EEE9F09750E8CC2421B7BF03AFD1B6A651F0BA6BA76395CA3E0DA65D` |
| Installer size | `83124657` bytes |
| Installer last write | `2026-06-30 10:43:50` |
| Portable/no-install SHA-256 | `D4BF332F0526E34C7501A0616D81CB26403CC77F124F1EB92B37A3796F39B39E` |
| Portable/no-install size | `82958908` bytes |
| Portable/no-install last write | `2026-06-30 10:43:51` |
