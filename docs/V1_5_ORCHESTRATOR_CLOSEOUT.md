...
| Gate | Evidence |
| --- | --- |
| Final readiness | `output\codex-evidence\final-readiness-20260626142032.json` |
| Evidence selection | `output\codex-evidence\v15-final-readiness-evidence-manifest-20260626142032.json` |
| Delivery bundle | `output\delivery-bundles\v15-delivery-bundle-20260626142032-ready` |
| Current package launch smoke | `output\codex-evidence\package-launch-smoke-1782454806549.json` |
...
| Field | Value |
| --- | --- |
| Installer SHA-256 | `5C99E7518A23DFC8AD4238A23FE31172292976F737B8961EF7244CBC85A15CB8` |
| Installer size | `83115877` bytes |
| Installer last write | `2026-06-26 14:19:52` |
| Portable/no-install SHA-256 | `A4EB58BABAF9F537BAA8EDE3AC691173E1849DBAAE802BC7BC24CCA1E396302F` |
| Portable/no-install size | `82950122` bytes |
| Portable/no-install last write | `2026-06-26 14:19:54` |
