...
| Gate | Evidence |
| --- | --- |
| Final readiness | `output\codex-evidence\final-readiness-20260630155240.json` |
| Evidence selection | `output\codex-evidence\v15-final-readiness-evidence-manifest-20260630155240.json` |
| Delivery bundle | `output\delivery-bundles\v15-delivery-bundle-20260630155240-ready` |
| Current package launch smoke | `output\codex-evidence\package-launch-smoke-1782805931162.json` |
...
| Field | Value |
| --- | --- |
| Installer SHA-256 | `B413DD859D39C1AB552DBAAD2328E5D9AF2D72FD341A671073A32C134E186D83` |
| Installer size | `83128007` bytes |
| Installer last write | `2026-06-30 15:51:58` |
| Portable/no-install SHA-256 | `96A7FDF7A82AC410546CC537FB237337E04051CEF3BC5CEB3128C484234C5A56` |
| Portable/no-install size | `82962254` bytes |
| Portable/no-install last write | `2026-06-30 15:52:00` |
