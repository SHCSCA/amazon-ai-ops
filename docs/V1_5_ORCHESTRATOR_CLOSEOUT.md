...
| Gate | Evidence |
| --- | --- |
| Final readiness | `output\codex-evidence\final-readiness-20260630094214.json` |
| Evidence selection | `output\codex-evidence\v15-final-readiness-evidence-manifest-20260630094214.json` |
| Delivery bundle | `output\delivery-bundles\v15-delivery-bundle-20260630094214-ready` |
| Current package launch smoke | `output\codex-evidence\package-launch-smoke-1782783709714.json` |
...
| Field | Value |
| --- | --- |
| Installer SHA-256 | `27E9B29686DBEDB032863BDB012D0CF34ABBAFF2206D29E66839B6E26D224EBD` |
| Installer size | `83123441` bytes |
| Installer last write | `2026-06-30 09:41:39` |
| Portable/no-install SHA-256 | `E6278462B37B949601294A464B95E59825BD7A5E60075ED4B6C5D865D2728ECC` |
| Portable/no-install size | `82957693` bytes |
| Portable/no-install last write | `2026-06-30 09:41:40` |
