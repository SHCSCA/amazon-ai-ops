...
5. Use the next-step action suggested by the page: no reports routes to `数据采集`, downloaded-but-unimported reports route to `数据导入与校验`, and imported metrics route to `广告量化`.
