...
2. Log in to Lingxing ERP through the visible browser session.
3. Open `v1.5 工作台`.
...
Current limitation: the Lingxing download center page model is still marked as requiring manual verification. Until the real page selectors are confirmed, report creation and download fail closed instead of pretending to succeed.
