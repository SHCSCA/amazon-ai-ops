...
3. Use the split left menu for the upgraded v1.5 workflow:
   ...
   - `关键词与 Listing` -> `关键词机会`: Search Term / SQP / keyword imports, ad-context-split opportunity analysis, filters, evidence columns, and sortable virtual-table headers with rotating arrow feedback.
