...
```powershell
pnpm run write:v15-evidence-manifest -- --ad-readback output\codex-evidence\real-ad-execution-readback-candidate-rec-4-current-pass.json --out output\codex-evidence\v15-final-readiness-evidence-manifest-20260626104249.json
```
...
```powershell
pnpm run verify:v15-final-readiness -- --evidence-manifest output\codex-evidence\v15-final-readiness-evidence-manifest-20260626104249.json --package-launch-smoke output\codex-evidence\package-launch-smoke-1782441741424.json --out output\codex-evidence\final-readiness-20260626104249.json
```
...
```powershell
pnpm run export:v15-delivery-bundle -- --final-readiness output\codex-evidence\final-readiness-20260626104249.json --data-reconciliation output\codex-evidence\real-lingxing-reconciliation-batch_20260612020905629_gkchz1.json --data-reconciliation-md output\codex-evidence\real-lingxing-reconciliation-batch_20260612020905629_gkchz1.md --out output\delivery-bundles\v15-delivery-bundle-20260626104249-ready
```

After the bundle is exported, run the READY safety gate:

```powershell
pnpm run verify:v15-ready-safety -- --final-readiness output\codex-evidence\final-readiness-20260626104249.json --bundle-manifest output\delivery-bundles\v15-delivery-bundle-20260626104249-ready\delivery-bundle-manifest.json
```
