...
Completed on 2026-06-22 in branch `codex/windows-desktop-ux-simplification`. Subagent-driven execution covered Tasks 1-10 with implementer/spec-review/quality-review loops, then Task 11 refreshed package smoke, final-readiness, READY bundle, and READY safety. Direct `build:win` from the long superpowers worktree hit an NSIS path-length limit, so the Windows package was built from a short temporary worktree, copied back into the current worktree release directory, and then `smoke:package-launch`, `verify:v15-final-readiness`, `export:v15-delivery-bundle`, and `verify:v15-ready-safety` were rerun from the current worktree.
...
- [x] **Step 1: Write tests for operator-facing term handling**
...
- [x] **Step 3: Implement `OperatorTaskPanel`**
...
- [x] **Step 4: Implement `ProgressiveDetails`**
...
- [x] **Step 1: Add tests for compact facts**
...
- [x] **Step 1: Add tests for dashboard first action**
...
- [x] **Step 2: Replace first viewport layout**
...
- [x] **Step 3: Demote duplicated panels**
...
- [x] **Step 1: Reduce first-viewport panels**
...
- [x] **Step 2: Collapse file/path/audit sections**
...
- [x] **Step 3: Keep the 8-report chooser but reduce copy**
...
- [x] **Step 4: Update smoke selectors**
...
- [x] **Step 1: Add tests for action-state copy**
...
- [x] **Step 2: Recommendations page first viewport**
...
- [x] **Step 3: Approval page first decision**
...
- [x] **Step 1: Add wizard logic tests**
...
- [x] **Step 2: Implement wizard module**
...
- [x] **Step 3: Refactor page rendering**
...
- [x] **Step 1: Test delivery matrix copy**
...
- [x] **Step 2: Delivery first viewport**
...
- [x] **Step 3: Move evidence internals**
...
- [x] **Step 1: Split settings into visible normal sections**
...
- [x] **Step 2: Collapse advanced sections**
...
- [x] **Step 2: Reduce repeated cards**
...
- [x] **Step 3: Verify by screenshots**
...
- [x] **Step 5: Rebuild package if implementation changed shipped UI**
...
- [x] **Step 6: Refresh final delivery evidence**
