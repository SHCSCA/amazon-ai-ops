...
- Authoritative final readiness: `output\codex-evidence\final-readiness-20260626142032.json`.
- Evidence manifest: `output\codex-evidence\v15-final-readiness-evidence-manifest-20260626142032.json`.
- Package launch smoke: `output\codex-evidence\package-launch-smoke-1782454806549.json`.
- READY bundle: `output\delivery-bundles\v15-delivery-bundle-20260626142032-ready`.
